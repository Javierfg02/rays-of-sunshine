...
public:
    ...
    static void renderDataDFS(SceneNode* node, glm::mat4& parentCTM, RenderData &renderData);
    static glm::mat4 applyTransformation(const SceneTransformation* transformation, const glm::mat4& currentMatrix);
};
